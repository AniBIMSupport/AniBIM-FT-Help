AniBIM website download access update
...
1. User submits trial request.
2. You approve manually.
3. You send installer download link by email.
4. User installs AniBIM FT.
5. User sends Machine ID.
6. You generate and send AniBIM_FT.lic.
